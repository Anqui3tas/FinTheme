...
```css
@import url('/theme/FinTheme/main/presets/monochromic_preset.css');
```
OR
```css
@import url('/theme/FinTheme/main/presets/kaleidochromic_preset.css');
```
OR
```css
@import url('/theme/FinTheme/main/presets/novachromic_preset.css');
```
...
```css
@import url('/theme/FinTheme/main/fixes.css');
@import url('/theme/FinTheme/main/jf_font.css');
```
...
```css
@import url('/theme/FinTheme/main/base.css');
@import url('/theme/FinTheme/main/accentlist.css');
```
...
```css
@import url('/theme/FinTheme/main/rounding.css');
```
OR
```css
@import url('/theme/FinTheme/main/rounding_circlehover.css');
```
...
```css
@import url('/theme/FinTheme/main/smallercast.css');
```
...
```css
@import url('/theme/FinTheme/main/episodelist/episodes_compactlist.css');
```
OR
```css
@import url('/theme/FinTheme/main/episodelist/episodes_grid.css');
```
...
```css
@import url('/theme/FinTheme/main/header/header_transparent.css');
```
...
```css
@import url('/theme/FinTheme/main/login/login_minimalistic.css');
```
OR
```css
@import url('/theme/FinTheme/main/login/login_frame.css');
```
...
```css
@import url('/theme/FinTheme/main/fields/fields_border.css');
```
OR
```css
@import url('/theme/FinTheme/main/fields/fields_noborder.css');
```
...
```css
@import url('/theme/FinTheme/main/cornerindicator/indicator_floating.css');
```
OR
```css
@import url('/theme/FinTheme/main/cornerindicator/indicator_corner.css');
```
...
```css
@import url('/theme/FinTheme/main/type/dark.css');
```
OR
```css
@import url('/theme/FinTheme/main/type/light.css');
```
OR
```css
@import url('/theme/FinTheme/main/type/colorful.css');
```
OR
```css
@import url('/theme/FinTheme/main/type/dark_withaccent.css');
```
...
```css
@import url('/theme/FinTheme/main/titlepage/title_simple.css');
```
OR
```css
@import url('/theme/FinTheme/main/titlepage/title_simple-logo.css');
```
OR
```css
@import url('/theme/FinTheme/main/titlepage/title_banner.css');
```
OR
```css
@import url('/theme/FinTheme/main/titlepage/title_banner-logo.css');
```
...
```css
@import url('/theme/FinTheme/main/overlayprogress.css');
```
OR
```css
@import url('/theme/FinTheme/main/bottombarprogress.css');
```
OR
```css
@import url('/theme/FinTheme/main/progress/floating.css');
```
...
```css
@import url('/theme/FinTheme/main/effects/hoverglow.css');
```
AND/OR
```css
@import url('/theme/FinTheme/main/effects/glassy.css');
```
AND/OR
```css
@import url('/theme/FinTheme/main/effects/pan-animation.css');
```
AND/OR
```css
...
```
add_header Content-Security-Policy "default-src https: data: blob:; style-src 'self' 'unsafe-inline' /theme/FinTheme/main/accentlist.css /theme/FinTheme/main/base.css /theme/FinTheme/main/bottombarprogress.css /theme/FinTheme/main/fixes.css /theme/FinTheme/main/jf_font.css /theme/FinTheme/main/overlayprogress.css /theme/FinTheme/main/rounding.css /theme/FinTheme/main/rounding_circlehover.css /theme/FinTheme/main/smallercast.css /theme/FinTheme/main/rounding_circlehover.css /theme/FinTheme/main/cornerindicator/indicator_floating.css /theme/FinTheme/main/cornerindicator/indicator_corner.css /theme/FinTheme/main/effects/glassy.css /theme/FinTheme/main/effects/pan-animation.css https://ctalvio.github.io/Monochromic/backdrop-hack_style.css /theme/FinTheme/main/effects/hoverglow.css /theme/FinTheme/main/effects/scrollfade.css /theme/FinTheme/main/episodelist/episodes_compactlist.css /theme/FinTheme/main/episodelist/episodes_grid.css /theme/FinTheme/main/fields/fields_border.css /theme/FinTheme/main/fields/fields_noborder.css /theme/FinTheme/main/header/header_transparent.css /theme/FinTheme/main/header/header_transparent-dashboard.css /theme/FinTheme/main/login/login_frame.css /theme/FinTheme/main/login/login_minimalistic.css /theme/FinTheme/main/login/login_frame.css /theme/FinTheme/main/presets/monochromic_preset.css /theme/FinTheme/main/presets/kaleidochromic_preset.css /theme/FinTheme/main/presets/novachromic_preset.css /theme/FinTheme/main/titlepage/title_banner.css /theme/FinTheme/main/titlepage/title_banner-logo.css /theme/FinTheme/main/titlepage/title_simple.css /theme/FinTheme/main/titlepage/title_simple-logo.css /theme/FinTheme/main/type/light.css /theme/FinTheme/main/type/dark.css /theme/FinTheme/main/type/colorful.css /theme/FinTheme/main/type/dark_withaccent.css https://fonts.googleapis.com/css2; script-src 'self' 'unsafe-inline' https://www.gstatic.com/cv/js/sender/v1/cast_sender.js worker-src 'self' blob:; connect-src 'self'; object-src 'none'; frame-ancestors 'self'";
```
